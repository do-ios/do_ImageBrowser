...
#import "UIImage+DOForceDecode.h"
#import "UIImage+DOMultiFormat.h"
#import <CommonCrypto/CommonDigest.h>

static NSString *cacheNameSpace;
...
@implementation DOImageCache {
    NSFileManager *_fileManager;
}

+ (void)cacheNameSpace:(NSString *)nameSpace
{
...
- (id)init {
    return [self initWithNamespace:@"do_ImageBrowser"];
}
...
- (id)initWithNamespace:(NSString *)ns {
    if ((self = [super init])) {
        ...
        _ioQueue = dispatch_queue_create("com.deviceone.imageBrowser", DISPATCH_QUEUE_SERIAL);
        ...
        // Init the disk cache
        _diskCachePath = [NSString stringWithFormat:@"%@/temp/%@",cacheNameSpace,ns];
