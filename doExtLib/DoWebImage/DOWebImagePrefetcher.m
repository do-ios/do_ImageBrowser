...
#import "DOWebImagePrefetcher.h"

#if (!defined(DEBUG) && !defined (SD_VERBOSE)) || defined(SD_LOG_NONE)
#define NSLog(...)
#endif

@interface DOWebImagePrefetcher ()

@property (strong, nonatomic) DOWebImageManager *manager;
...
@implementation DOWebImagePrefetcher
...
- (id)init {
    if ((self = [super init])) {
        _manager = [DOWebImageManager new];
